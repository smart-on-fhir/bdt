...
export declare type SupportedJWKAlgorithm = 'RS256' | 'RS384' | 'RS512' | 'ES256' | 'ES384' | 'ES512';
 ...
 */
export declare function createAuthToken({ algorithm, privateKey, header, claims, expiresIn, tokenEndpoint, jwksUrl, clientId }: createAuthTokenOptions): string;
